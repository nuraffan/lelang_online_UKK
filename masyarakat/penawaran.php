                      ...
                      <tr>
                        ...
                        <td>  
                          <?php if ($d_history_lelang['penawaran_harga'] == $d_history_lelang['harga_akhir']) { ?>
                            <a href="https://api.whatsapp.com/send?phone=6285714495603&text=Admin, Saya Pemenang Lelangnya" class="btn btn-primary">Congratulations, Anda pemenang lelangnya</a>
                          <?php } else { ?>
                            -
                          <?php } ?>          
                        </td>
