...
mysqli_query($koneksi,"update tb_barang set nama_barang='$nama_barang',tgl='$tgl',harga_awal='$harga_awal',deskripsi_barang='$deskripsi_barang',tb_gambar='$tb_gambar'where id_barang='$id_barang'");
